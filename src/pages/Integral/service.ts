...
/**审核积分补录小票接口*/
export async function RepitExamineHandle(params: TableListItem) {
  return request(`${prefix}/ScoresSupplementToUi/RepitExamineHandle`, {
    method: 'POST',
    data: {
      ...params,
    },
...
/**查询积分补录汇总记录接口*/
export async function QueryScoresSupplementSummary(params: TableListItem) {
  return request(`${prefix}/ScoresSupplementToUi/QueryScoresSupplementSummary?${stringify(params)}`);
}
